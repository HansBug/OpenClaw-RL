...
echo "  AGENT57_LITE    = ${EXPLORE_AGENT57_LITE_ENABLED}/${EXPLORE_AGENT57_LITE} (k=${EXPLORE_AGENT57_K}, controller=${EXPLORE_AGENT57_CONTROLLER}, betas=${EXPLORE_AGENT57_ARM_BETAS}, temps=${EXPLORE_AGENT57_ARM_TEMPERATURES:-<inherit>})"
echo "  AGENT57_LIFE    = ${EXPLORE_AGENT57_LIFELONG_ENABLED}/${EXPLORE_AGENT57_LIFELONG} (coef=${EXPLORE_AGENT57_LIFELONG_COEF}, clip=${EXPLORE_AGENT57_LIFELONG_CLIP}, warmup=${EXPLORE_AGENT57_LIFELONG_WARMUP}, backend=${EXPLORE_AGENT57_LIFELONG_BACKEND})"
...
export EXPLORE_AGENT57_LITE EXPLORE_AGENT57_LITE_ENABLED EXPLORE_AGENT57_K EXPLORE_AGENT57_ARM_BETAS EXPLORE_AGENT57_ARM_TEMPERATURES EXPLORE_AGENT57_ARM_TOP_PS EXPLORE_AGENT57_ARM_TOP_KS
export EXPLORE_AGENT57_CONTROLLER EXPLORE_AGENT57_UCB_C EXPLORE_AGENT57_UCB_WINDOW EXPLORE_AGENT57_KEEP_BASELINE
export EXPLORE_AGENT57_LIFELONG EXPLORE_AGENT57_LIFELONG_ENABLED EXPLORE_AGENT57_LIFELONG_COEF EXPLORE_AGENT57_LIFELONG_CLIP EXPLORE_AGENT57_LIFELONG_WARMUP EXPLORE_AGENT57_LIFELONG_BACKEND EXPLORE_AGENT57_STATE_PATH EXPLORE_AGENT57_SUCCESS_THRESHOLD
