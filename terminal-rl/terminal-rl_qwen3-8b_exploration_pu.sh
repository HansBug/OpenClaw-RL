...
echo "  AGENT57_LITE    = ${EXPLORE_AGENT57_LITE_ENABLED}/${EXPLORE_AGENT57_LITE} (k=${EXPLORE_AGENT57_K}, controller=${EXPLORE_AGENT57_CONTROLLER}, combine=${EXPLORE_AGENT57_COMBINE_MODE}, ngu_clip=${EXPLORE_AGENT57_NGU_MOD_CLIP}, max_bonus=${EXPLORE_AGENT57_MAX_BONUS}, betas=${EXPLORE_AGENT57_ARM_BETAS}, temps=${EXPLORE_AGENT57_ARM_TEMPERATURES:-<inherit>})"
