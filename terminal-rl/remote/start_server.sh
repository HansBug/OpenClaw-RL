...
echo "  force_cleanup:        enabled=${TERMINAL_ENV_FORCE_DOCKER_CLEANUP} broad=${TERMINAL_ENV_FORCE_DOCKER_CLEANUP_BROAD} always=${TERMINAL_ENV_FORCE_DOCKER_CLEANUP_ALWAYS} batch_timeout=${WORKER_SHUTDOWN_FORCE_CLEANUP_TIMEOUT}s"
