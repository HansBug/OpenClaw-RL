...
export WORKER_ALLOCATED_TTL="${WORKER_ALLOCATED_TTL:-120}"
export WORKER_RESETTING_TTL="${WORKER_RESETTING_TTL:-900}"
export WORKER_CLOSING_REQUESTED_TTL="${WORKER_CLOSING_REQUESTED_TTL:-300}"
export WORKER_PIDS_PAUSE_ALLOCATE_PCT="${WORKER_PIDS_PAUSE_ALLOCATE_PCT:-60}"
export WORKER_PIDS_REJECT_RESET_PCT="${WORKER_PIDS_REJECT_RESET_PCT:-70}"
...
export WORKER_SHIM_PAUSE_ALLOCATE="${WORKER_SHIM_PAUSE_ALLOCATE:-180}"
export WORKER_SHIM_REJECT_RESET="${WORKER_SHIM_REJECT_RESET:-220}"
