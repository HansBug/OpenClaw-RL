...
export WORKER_ORPHAN_DOCKER_SWEEP_INTERVAL="${WORKER_ORPHAN_DOCKER_SWEEP_INTERVAL:-60}"
export WORKER_ORPHAN_DOCKER_SWEEP_MIN_AGE="${WORKER_ORPHAN_DOCKER_SWEEP_MIN_AGE:-600}"
export WORKER_ORPHAN_DOCKER_SWEEP_MAX_REMOVE="${WORKER_ORPHAN_DOCKER_SWEEP_MAX_REMOVE:-128}"
export WORKER_ORPHAN_DOCKER_SWEEP_TIMEOUT="${WORKER_ORPHAN_DOCKER_SWEEP_TIMEOUT:-30}"
