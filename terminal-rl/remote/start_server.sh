...
export WORKER_RESET_OPERATION_TIMEOUT="${WORKER_RESET_OPERATION_TIMEOUT:-330}"
export WORKER_RESETTING_TTL="${WORKER_RESETTING_TTL:-390}"
...
export WORKER_REPAIR_RESETTING_MIN_AGE="${WORKER_REPAIR_RESETTING_MIN_AGE:-390}"
