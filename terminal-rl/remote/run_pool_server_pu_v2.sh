...
WORKER_RESET_OPERATION_TIMEOUT="${WORKER_RESET_OPERATION_TIMEOUT:-360}"  # P0 FIX: 720→360s fail fast on hung ops
WORKER_RESETTING_TTL="${WORKER_RESETTING_TTL:-450}"  # P0 FIX: 900→450s match reduced timeout
...
WORKER_CLOSE_REQUESTED_FORCE_RELEASE_AFTER="${WORKER_CLOSE_REQUESTED_FORCE_RELEASE_AFTER:-30}"
...
WORKER_REPAIR_RESETTING_MIN_AGE="${WORKER_REPAIR_RESETTING_MIN_AGE:-450}"  # P1 FIX: match WORKER_RESETTING_TTL
