...
class RunPaths:
    ...
    def from_env(cls) -> "RunPaths":
        ...
        ckpt_root = Path(os.getenv(
            "CKPT_ROOT",
            "/mnt/shared-storage-gpfs2/narmodel/lixueyan/agenticrl/ckpt"
        ))
...
if __name__ == "__main__":
    ...
    init_p.add_argument("--ckpt-root", default="/mnt/shared-storage-gpfs2/narmodel/lixueyan/agenticrl/ckpt")
